 ...
 */
public class InfoEditNicknameActivity extends BaseActivity {
    ...
    protected void onStart() {
        super.onStart();
        mActionBarFragment.setMiddleText(R.string.info_nick_name);

        mActionBarFragment.setRightTextAndListener(getString(R.string.personal_info_save), new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (StringUtils.isEmpty(mEtNickName.getText().toString())) {
                    ToastUtils.show(InfoEditNicknameActivity.this, R.string.nickname_cann_not_empty);
                } else {
                    SharedPreferences.Editor editor = mSharedPreference.edit();
                    editor.putString(Constant.USER_NICKNAME, mEtNickName.getText().toString());
                    editor.commit();
                    InfoEditNicknameActivity.this.finish();
                }
            }
        });
    }
    ...
    protected void initializeViews(Bundle savedInstanceState) {
        mEtNickName = getViewById(R.id.et_name);
        mIvDelete = getViewById(R.id.iv_delete);
    }

    @Override
    protected void initializeData(Bundle savedInstanceState) {
        mEtNickName.setText(mSharedPreference.getString(Constant.USER_NICKNAME, ""));
    ...
    public void onClick(View v) {
       ...
       if(target == R.id.iv_delete) {
            mEtNickName.setText(StringUtils.EMPTY_STRING);
        }
    }
