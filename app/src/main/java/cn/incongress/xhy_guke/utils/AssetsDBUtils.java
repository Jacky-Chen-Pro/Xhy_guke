...
import cn.incongress.xhy_guke.bean.CityBean;
import cn.incongress.xhy_guke.bean.HospitalBean;
import cn.incongress.xhy_guke.bean.SchoolBean;
import cn.incongress.xhy_guke.bean.SchoolProvinceBean;
    ...
    public static List<CityBean> getAllCity() {
        ...
        if(cursor != null) {
            while(cursor.moveToNext()) {
                ...
                beans.add(new CityBean(cityId,name,pinyin,provinceId));
            }
        }
        return beans;
    }
